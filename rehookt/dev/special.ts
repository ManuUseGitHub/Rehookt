 ...
 * @return {any[]}
 */
const redefineByXFunct = ( entry: IStateDescription ): any[] => {
...
const computeSpecialHooks = (
  ...
  return cleanUpGenerationHooks( computeStatenameAndUse , definitions ).concat(
    generations
  );
};
...
export { computeSpecialHooks , doesRejectHooks , getKeyMapping };
